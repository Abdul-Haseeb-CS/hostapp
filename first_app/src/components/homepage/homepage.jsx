        ...
        <div className="max-w-7xl mx-auto px-4 py-12 lg:py-20">
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 max-w-3xl mx-auto">
                Advanced encryption, multi-factor authentication, and continuous
          ...
          >
            <div className="text-center mb-8">
              ...
              <p className="text-gray-300 max-w-3xl mx-auto">
                Our team of specialized IT professionals understands the unique
                needs of tax and accounting firms
              </p>
            </div>
